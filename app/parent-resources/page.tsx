      ...
      <section className="py-20" style={{ background: '#faf8f3' }}>
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: '✋', title: 'What is Spelling to Communicate (S2C)?', body: 'Spelling to Communicate (S2C) is an educational method designed to help individuals with complex communication needs develop the purposeful motor skills required to point accurately to letters and spell as a means of communication. Working with a trained practitioner, students engage in structured lessons that support regulation, motor planning, and increasingly independent communication while presuming competence and providing meaningful opportunities for learning.' },
              { icon: '🧠', title: 'The Motor Connection', body: 'Research and clinical observation suggest that many individuals with complex communication needs also experience motor differences that affect their ability to consistently execute intentional movements, including speech. S2C focuses on developing purposeful motor control through structured, progressively challenging activities that support accurate letter selection for communication.' },
              { icon: '📋', title: 'What Does a Session Look Like?', body: 'Each session begins with the practitioner observing the student\'s level of regulation and readiness for learning. When needed, strategies are incorporated to support regulation before instruction begins. Sessions then move into an academically rich lesson, where the practitioner uses a letterboard, verbal coaching, and gestural cues to support purposeful motor responses. Through structured instruction and consistent practice, students develop increasingly reliable motor control for accurate letter selection and communication through spelling.' },
