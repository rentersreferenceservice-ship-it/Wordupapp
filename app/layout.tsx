...
export const metadata: Metadata = {
  title: "Word Up | S2C Practitioner · New Hampshire",
  description: "Word Up LLC offers S2C sessions, family support, and practitioner tools in New Hampshire. Certified S2C practitioner Melody presumes competence and tracks real progress.",
  keywords: ["S2C", "S2C practitioner", "AAC", "non-speaking", "nonspeaker", "autism communication", "S2C lesson generator", "presuming competence"],
  icons: {
