...
export default function RootNav() {
  ...
  return (
    <div className="relative z-20 flex justify-end items-center gap-3 px-6 py-3 print:hidden">
      <a href="/practitioner/dashboard" className="bg-white text-gray-900 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors">Practitioner Login</a>
