  ...
  return (
    <main className="relative z-10 min-h-screen px-4 py-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6 bg-white border-4 border-gray-300 rounded-xl px-5 py-4">
        <div>
          <Link href="/generate" className="inline-block bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors mb-3">← Generate Lesson</Link>
        ...
        <div className="flex flex-col gap-2 shrink-0">
          <Link href="/generate" className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors text-center">
            + New Lesson
          </Link>
      ...
      {lessons.length === 0 ? (
        <div className="text-center py-20 text-gray-400">
          ...
          <Link href="/generate" className="text-blue-600 text-sm hover:underline mt-2 inline-block">Generate your first lesson</Link>
        </div>
      ) : filtered.length === 0 ? (
