  ...
  return (
    <main className="relative z-10 min-h-screen px-4 py-10 max-w-2xl mx-auto">
      ...
      <div className="mb-4 bg-green-50 border-2 border-black rounded-xl px-5 py-4">
        <p className="text-sm text-green-900"><span className="font-bold">✓ Verified for Accuracy</span> — Lessons marked Verified have completed a three-step accuracy review: AI generation, plus independent AI review by Perplexity AI (real-time web search with cited sources) and Google Gemini (Google&apos;s knowledge base). Reviewed for factual accuracy by the Word Up team.</p>
      </div>
