    ...
    return `
      <div style="margin-bottom:16px;">
        <div style="break-inside:avoid;page-break-inside:avoid;">
          ${hunk.imageUrl ? `<img src="${hunk.imageUrl}" style="width:100%;max-height:200px;height:auto;object-fit:contain;border-radius:8px;margin-bottom:8px;background:#f9fafb;" />` : ''}
